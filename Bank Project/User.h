...
private:
    ...
    static stLoginRegisterRecord _ConvertLoginRegisterLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        LoginRegisterRecord.Password = Util::DecryptText(LoginRegisterDataLine[2]);
    ...
    static User _ConvertLinetoUserObject(string Line, string Seperator = "#//#")
    {
        ...
        return User(enMode::UpdateMode, vUserData[0], vUserData[1], vUserData[2],
            vUserData[3], vUserData[4], Util::DecryptText(vUserData[5]), stoi(vUserData[6]));
    ...
    static string _ConverUserObjectToLine(User User, string Seperator = "#//#")
    {
        ...
        //here we encypt store the encrypted Password not the real one.
        UserRecord += Util::EncryptText(User.Password) + Seperator;
    ...
    {
        return Util::EncryptText(Password);
    }
...
public:
    ...
    enum enPermissions {
        ...
        pShowLogInRegister = 128 , pShowCurrnciesExchange = 256
    };
